...
export const actionsByLane: Record<LaneId, Action[]> = {
  partnerships: [
    ...
    },
    {
      ...
      minutes: 45,
      description: 'Create a concise deck highlighting audience, engagement, and ROI opportunities.',
  ...
  growth: [
    ...
    },
    {
      ...
      minutes: 30,
      description: 'Create a 3-email sequence to re-engage customers who haven\'t purchased recently.',
  ...
  nil: [
    {
      ...
      minutes: 30,
      description: 'Understand current regulations and any recent changes affecting student-athletes.',
  ...
  bizops: [
    {
      ...
      minutes: 45,
      description: 'Apply a problem-solving framework (e.g., 5 Whys, Issue Tree) to a current challenge.',
